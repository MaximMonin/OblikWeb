 ...
 package org.doc
{
	...
	public class Document
	{
		...
		public function set paperFormat(paperFormat : PaperFormat):void {
			if (_paperFormat != paperFormat)
			{
			}
			_paperFormat = paperFormat;
			_template.width = paperFormat.width;
			_template.height = paperFormat.height;
		}
		...
		public function capturePages():void
		{
            ...
            // Convert all pages of Report to BitMap Arrays of Snapshot and Thumb
			do {
				// Convert the current page of the Report template to ByteArray of BitMap
				// Add the converted ByteArray of Snapshot Bitmap to the pages array
				// Add the converted ByteArray of Thumb Bitmap to the pages array 
		...
		public function doPrint():void
		{
			...
			if (printJob.start()) {
				_template.height = printJob.pageHeight;
	 			_template.width = printJob.pageWidth;
